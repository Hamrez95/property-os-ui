...
export const PROTOTYPE_SCREENS: PrototypeScreen[] = [
  ...
  { path: '/join-residence', label: 'پیوستن به محل سکونت', group: 'mobile' },
  { path: '/join-residence-match', label: 'تطبیق ساختمان و واحد', group: 'mobile' },
  { path: '/tenant-request-sent', label: 'درخواست سکونت ارسال شد', group: 'mobile' },
  { path: '/claim-ownership', label: 'Claim مالکیت', group: 'mobile' },
  { path: '/claim-ownership-evidence', label: 'مدرک Claim مالکیت', group: 'mobile' },
  { path: '/building-invite', label: 'دعوت به ساختمان', group: 'mobile' },
  ...
  { path: '/building-announcement-new', label: 'ایجاد اعلان ساختمان', group: 'mobile' },
  ...
  { path: '/support-ticket', label: 'جزئیات تیکت پشتیبانی', group: 'mobile' },
  { path: '/support-new', label: 'درخواست پشتیبانی جدید', group: 'mobile' },
  ...
  { path: '/admin-support-ticket', label: 'Support Ticket Detail', group: 'admin' },
